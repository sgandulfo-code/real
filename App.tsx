      ...
      <header className="h-16 border-b bg-white/80 backdrop-blur-md flex items-center px-6 justify-between sticky top-0 z-50">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right hidden sm:block">
            ...
            <button onClick={handleLogout} className="text-[10px] font-bold text-slate-400 uppercase tracking-widest hover:text-red-500 transition-colors">Cerrar Sesión</button>
          </div>
